...
function estimateInvestment(principal, interestRate, years) {
  ...
  if (
    ...
    console.log("виводимо повідомлення про помилку в консоль");
    return null;
  }
...
function isTotalPriceExceedsMaxPrice(products, maxPrice) {
  ...
  if (!Array.isArray(products)) {
    console.log("виводимо повідомлення про помилку");
    return null;
  }
  ...
  const totalPrice = products.reduce((accum, product) => accum + product.price);
